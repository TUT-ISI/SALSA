...
F90FLAGS = -cpp -g -fbacktrace -DSALSA -std=legacy -ffpe-trap=invalid,zero,overflow -O -DNOMPI -D__x86_64 -I./include -I/usr/include/
...
driver.o : driver.F90 mo_convert_concentrations.o mo_hammoz_sedimentation.o mo_ham_activ.o mo_read_netcdf77.o mo_hammoz_wetdep.o mo_param_switches.o mo_activ.o mo_ham_subm.o mo_tracdef.o mo_ham_salsa_cloud.o mo_filename.o mo_submodel.o mo_math_constants.o mo_physical_constants.o mo_time_control.o mo_kind.o mo_ham_subm_species.o mo_ham_salsa_sizedist.o mo_ham_salsactl.o mo_ham_salsa.o mo_ham_init.o mo_ham.o mo_ham_salsa_init.o driver_input.o mo_ham_species.o mo_species.o 
