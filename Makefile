...
SRCS =	driver.f90 driver_input.f90 mo_constants.f90 mo_doctor.f90 \
	...
	mo_salsa_properties.f90 mo_salsa_sizedist.f90 mo_salsa_update.f90 \
	mo_submctl.f90 mo_time_control.f90
...
OBJS =	driver.o driver_input.o mo_constants.o mo_doctor.o mo_exception.o \
	...
	mo_salsa_sizedist.o mo_salsa_update.o mo_submctl.o mo_time_control.o
...
mo_salsa.o: mo_kind.o mo_salsa_dynamics.o mo_salsa_init.o \
	mo_salsa_nucleation.o mo_salsa_properties.o mo_salsa_update.o \
	mo_submctl.o
mo_salsa_cloud.o: mo_kind.o mo_submctl.o
